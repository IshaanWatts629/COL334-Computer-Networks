...
void ReLink (Ptr<Node> nodeA, Ptr<Node> nodeB, uint32_t interfaceA, uint32_t interfaceB)
{
...
//  listRH.Add (staticRh, 5);
  ...
  if (printRoutingTables)
    {
      ...
      routingHelper.PrintRoutingTableAt (Seconds (29.0), a, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (29.0), b, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (29.0), c, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (29.0), d, routingStream);

      routingHelper.PrintRoutingTableAt (Seconds (79.0), a, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (79.0), b, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (79.0), c, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (79.0), d, routingStream);

      routingHelper.PrintRoutingTableAt (Seconds (149.0), a, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (149.0), b, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (149.0), c, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (149.0), d, routingStream);

      routingHelper.PrintRoutingTableAt (Seconds (280.0), a, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (280.0), b, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (280.0), c, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (280.0), d, routingStream);
    }
  ...
  Simulator::Schedule (Seconds (30), &TearDownLink, b, d, 3, 2);
  Simulator::Schedule (Seconds (30), &TearDownLink, c, d, 3, 1);

  Simulator::Schedule (Seconds (80), &ReLink, c, d, 3, 1);
  Simulator::Schedule (Seconds (150), &ReLink, b, d, 3, 2);
